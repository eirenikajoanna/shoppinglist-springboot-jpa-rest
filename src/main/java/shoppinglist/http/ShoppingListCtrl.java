...
//        List<DaftarBelanja> searchResult = service.search(keyword);
//        System.out.println("Keyword: " + keyword);
//        System.out.println(searchResult);
//        return ResponseEntity.ok("Search Completed.");
//    }
//
//    @GetMapping("/DaftarBelanja/{id}")
//    public ResponseEntity<String> getDaftarBelanjaById(@PathVariable long id) {
//        DaftarBelanja entity = service.getProductById(id);
